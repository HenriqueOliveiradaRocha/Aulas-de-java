	...
	public Calculadora(){
		...
		btnfigual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//ao apertar o sinal = 1.sera identificado qual operador foi utilizado 2.o calculo será efetuado 3.resultado aparecera na tela
				if(sinal.equals("soma")) {
					visor.setText(mat.soma(valor1, valor2) + "");
				}else if (sinal.equals("subtrair")) {
					visor.setText(mat.subtrair(valor1, valor2) + "");
				}else if (sinal.equals("divisao")) {
					visor.setText(mat.dividir(valor1, valor2) + "");
